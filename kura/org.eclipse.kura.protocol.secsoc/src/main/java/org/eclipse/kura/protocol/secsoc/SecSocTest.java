...
import org.eclipse.kura.protocol.secsoc.comm.SecSocConnectionServiceImpl;
import org.eclipse.kura.protocol.secsoc.comm.SerialInterfaceParameters;
...
public class SecSocTest implements ConfigurableComponent, CloudClientListener {
	private static final Logger s_logger = LoggerFactory.getLogger(SecSocTest.class);

	// Cloud Application identifier
	private static final String APP_ID = "SECSOC_TEST";
	...
	private SecSocConnectionService m_connService;
	...
	protected void activate(ComponentContext componentContext, Map<String,Object> properties) {
		...
		s_logger.info("Activating SECSOC test... Done.");
	}

	protected void deactivate(ComponentContext componentContext){
		s_logger.info("Deactivating SECSOC test...");
		...
		s_logger.info("Deactivating SECSOC test... Done.");
	}	

	public void updated(Map<String,Object> properties){
		s_logger.info("Updated SECSOC test...");

		// try to kick off a new job
		doUpdate(properties);
		s_logger.info("Updated SECSOC test... Done.");
	}
	...
	private void doUpdate(Map<String, Object> properties) {
		try {
			...
			m_connService= new SecSocConnectionServiceImpl();
			closePort();
	...
	private void openPort() {
		...
		try {
			m_connService.openSecSocConnection(sip, m_connectionFactory);
	...
	private void cleanupPort() {
			try {
				...
				m_connService.closeSecSocConnection();
