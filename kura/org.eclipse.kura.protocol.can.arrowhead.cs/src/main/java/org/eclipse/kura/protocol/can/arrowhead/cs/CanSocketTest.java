...
public class CanSocketTest implements ConfigurableComponent {
 ...
 // [0-No;1-Yes]
    ...
    private void sendMessage1(String ifName) throws KuraException, IOException {
        ...
        int timeToRechargeMinutes = message1Info.getTimeToRechargeMinutes(); // Time
                                                                             // to
                                                                             // recharge
                                                                             // [minutes]
        int timeToRechargeSeconds = message1Info.getTimeToRechargeSeconds(); // Time
                                                                             // to
                                                                             // recharge
                                                                             // [seconds]
    ...
    private void sendMessage2(String ifName) throws KuraException, IOException {
        ...
        int rechargeAvailable = (message2Info.isRechargeAvailable() << 1); // recharge
                                                                           // available
                                                                           // [0,1]
        int rechargeInProgress = (message2Info.isRechargeInProgress() << 2); // recharge
                                                                             // in
                                                                             // progress
                                                                             // [0,1]
        int pvSystemActive = (message2Info.isPvSystemActive() << 3); // Pv
                                                                     // System
                                                                     // Active
                                                                     // [0,1]
        int auxChargerActive = (message2Info.isAuxChargerActive() << 4); // Aux
                                                                         // Charger
                                                                         // Active
                                                                         // [0,1]
        int storageBatteryContractorStatus = (message2Info.isStorageBatteryContactorStatus() << 5); // Storage
                                                                                                    // Battery
                                                                                                    // Contactor
                                                                                                    // Status
                                                                                                    // [0,1]
        int converterContractorStatus = (message2Info.isConverterContactorStatus() << 6); // Converter
                                                                                          // Contactor
                                                                                          // Status
                                                                                          // [0,1]
